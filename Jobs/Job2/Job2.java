...
//Asigna las variables
	...
	if(line.charAt(1) == 'Â'){//titulo
		titulo = line.substring(4);}
            ...
            currentWord = new Text(word + "," + url + "," + titulo + ",");//Lave con la palabra, url y titulo
            context.write(currentWord,one);//Escritura llave con valor = 1
  ...
  public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public void reduce(Text word, Iterable<IntWritable> counts, Context context)
      ...
      context.write(word, new IntWritable(sum));//Escritura de la llave con el total
    }
  }
}
